...
void StatisticsPage::updateStatistics()
{
    ...
    {
        subsidy = "0.2 AMC per block";
    }
    else if (pindexBest->nHeight <= 3398)
    {
        subsidy = "0.5 AMC per block";
    }
    ...
    {
        subsidy = "0.1 AMC per block";
    }
    else if (pindexBest->nHeight > 2000000)
    {
        subsidy = "0.01 AMC per block";
    }
    else if (pindexBest->nHeight <= 3000000)
    {
        subsidy = "0";
    ...
    {
        ui->volumeBox->setText("<b><font color=\"yellow\">" + qVolume + " AMC" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " AMC" + "</font></b>");
    } else {
        ui->volumeBox->setText("<b><font color=\"orange\">" + qVolume + " AMC" + "</font></b>");
    }
