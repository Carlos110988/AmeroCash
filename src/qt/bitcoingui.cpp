...
{
    resize(1300, 400);
    setWindowTitle(tr("AmeroCash") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/amerocash"));
    setWindowIcon(QIcon(":icons/amerocash"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    blockAction->setToolTip(tr("Explore the AmeroCash Blockchain"));
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a AmeroCash address"));
    ...
    masternodeManagerAction->setToolTip(tr("Show AmeroCash Masternodes status and configure your nodes."));
    masternodeManagerAction->setCheckable(true);
    tabGroup->addAction(masternodeManagerAction);

    proofOfImageAction = new QAction(QIcon(":/icons/data"), tr("&Proof of Data"), this);
    proofOfImageAction ->setToolTip(tr("Timestamp Files on the AmeroCash blockchain."));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About AmeroCash"), this);
    aboutAction->setToolTip(tr("Show information about AmeroCash"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for AmeroCash"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("AmeroCash client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("AmeroCash client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AmeroCash network", "", count));
    ...
    if(fNativeTor)
    {
        ...
        labelConnectTypeIcon->setToolTip(tr("Not Connected via the Tor Network, Start AmeroCash with the flag nativetor=1"));
    }
}
...
void BitcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
    ...
    {
        progressBarLabel->setText(tr("Connecting to the AmeroCash network..."));
...
void BitcoinGUI::showConfEditor()
{
    ...
    /* Open amerocash.conf with the associated application */
    if (boost::filesystem::exists(pathConfig)) {
        QDesktopServices::openUrl(QUrl::fromLocalFile(QString::fromStdString(pathConfig.string())));
	} else {
		QMessageBox::warning(this, tr("No amerocash.conf"),
        tr("Your amerocash.conf does not exist! Please create one in your AmeroCash data directory."),
...
void BitcoinGUI::showMNConfEditor()
{
    ...
    if (boost::filesystem::exists(pathMNConfig)) {
        ...
        tr("Your masternode.conf does not exist! Please create one in your AmeroCash data directory."),
        QMessageBox::Ok, QMessageBox::Ok);
	}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid AmeroCash address or malformed URI parameters."));
    }
