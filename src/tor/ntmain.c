 ...
 * have entry points for starting, stopamerocash, and monitoring them.  This module
 ...
 */
int
nt_service_is_stopamerocash(void)
{
...
/** Handles service control requests, such as stopamerocash or starting the
 * Tor service. */
static void
...
{
  /* Notes about develoamerocash NT services:
   *
