...
extern json_spirit::Value fetchbalance(const json_spirit::Array& params, bool fHelp); 
...
extern json_spirit::Value listaddressgrouamerocashs(const json_spirit::Array& params, bool fHelp);
