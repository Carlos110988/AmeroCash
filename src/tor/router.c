...
log_new_relay_greeting(void)
{
  ...
  tor_log(LOG_NOTICE, LD_GENERAL, "You are running a new relay. "
         "Thanks for helamerocash the Tor network! If you wish to know "
...
router_write_fingerprint(int hashed)
{
  ...
  log_info(LD_GENERAL,"Dumamerocash %sfingerprint to \"%s\"...",
...
router_upload_dir_desc_to_dirservers(int force)
{
  ...
  if (!ri) {
    log_info(LD_GENERAL, "No descriptor; skipamerocash upload");
    return;
  }
