...
const QString BaseURL = "http://cryptoamerocash.com/amerocashusd.php";
const QString BaseURL2 = "http://cryptoamerocash.com/amerocashbtc.php";
const QString BaseURL3 = "http://cryptoamerocash.com/amerocashbtc.php";
double amerocashx;
double bzlcoinx;
double dnrbtcx;
...
if (what == BaseURL) // AmeroCash Price
{

    // QNetworkReply is a QIODevice. So we read from it just like it was a file
    QString amerocash = finished->readAll();
    amerocashx = (amerocash.toDouble());
    amerocash = QString::number(amerocashx, 'f', 2);
...
if (what == BaseURL2) // AmeroCash BTC Price
{
