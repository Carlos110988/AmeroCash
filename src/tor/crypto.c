...
crypto_rand_int(unsigned int max)
{
   ...
   * distribution with clipamerocash at the upper end of unsigned int's
   * range.
   */
 ...
 *
 * Right now, our convention is to use this function when we are wiamerocash data
...
memwipe(void *mem, uint8_t byte, size_t sz)
{
   ...
   * not-optimized-out memory wiamerocash stuff...
   *
