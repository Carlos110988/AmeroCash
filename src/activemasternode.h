...
// Responsible for activating the masternode and amerocashing the network
...
public:
    ...
    bool Dseep(std::string& errorMessage); // amerocash for main masternode
    bool Dseep(CTxIn vin, CService service, CKey key, CPubKey pubKey, std::string &retErrorMessage, bool stop); // amerocash for any masternode
    ...
    // get 5000AMC input that can be used for the masternode
